...
const MemberDetails = () => {
  ...
  const [member, setMember] = useState(() =>
    membersData.find((m) => m.id === parseInt(id))
  );
  ...
  useEffect(() => {
    const fetchMember = async () => {
      try {
        const response = await axios.get(`https://lesserafimapi.onrender.com/api/members/${id}`);
        setMember(response.data);
      } catch (err) {
        console.error(err);
        setError("Failed to fetch live member data.");
      }
    };
  ...
  return (
    <div className="container mt-5 mb-5" data-aos="fade-right">
      <button
        ...
        onClick={() => navigate("/", { state: { scrollTo: "members" } })}
      >
        ← Back to Homepage
      </button>
      <div className="card shadow-lg p-4">
        <p>
          ...
          <a
            href="https://kprofiles.com/le-sserafim-members-profile/"
            target="_blank"
            rel="noreferrer"
          >
            LE SSERAFIM Members Profile
          </a>
        </p>
        <div className="row">
          <div className="col-md-4 text-center">
            <img
              src={member.image2URL || member.imageSrc2}
              alt={member.name}
          ...
          <div className="col-md-8">
            ...
            <ul className="list-group list-group-flush">
              ...
              <li className="list-group-item">
                ...
                {new Date(member.birthday).toLocaleDateString("en-CA", {
                  timeZone: "UTC",
                  year: "numeric",
                  month: "2-digit",
                  day: "2-digit",
              ...
              <li className="list-group-item"><strong>Height:</strong> {member.height} cm</li>
              <li className="list-group-item"><strong>Weight:</strong> {member.weight} kg</li>
              <li className="list-group-item"><strong>Blood Type:</strong> {member.bloodtype || member.bloodType}</li>
